...
namespace RiceTea.ArraySorts
{
    ...
    {
        /// <summary>
        /// Sorts the elements with QuickSort algorithm in an entire <see cref="IList{T}" /> using the <see cref="IComparable{T}"/> generic interface implementation of each element of the <see cref="IList{T}" />.
        /// </summary>
