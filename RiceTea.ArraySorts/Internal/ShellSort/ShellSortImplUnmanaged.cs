...
#pragma warning disable CS8500 // 這會取得 Managed 類型的位址、大小，或宣告指向它的指標
    internal static unsafe class ShellSortImplUnmanaged<T>
    {
        public static void Sort(T* ptr, T* ptrEnd, IComparer<T> comparer)
        {
            ...
            if (count < 2 || SortUtils.ShortCircuitSort(ptr, count, comparer) || SortUtils.CheckPattern(ptr, ptrEnd, comparer))
                return;
        ...
        public static void SortOnce(T* ptr, T* ptrEnd, IComparer<T> comparer, long step)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SortCore(T* ptr, T* ptrEnd, IComparer<T> comparer, long step)
        {
