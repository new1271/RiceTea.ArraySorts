...
namespace RiceTea.ArraySorts
{
    ...
    {
        /// <summary>
        /// Sorts the elements with IntroSort algorithm in an entire <see cref="Array" /> 
        ...
        public static void IntroSort<T>(T[] array)
        {
            ...
            IntroSortCore(array, 0, length, null);
        }

        /// <summary>
        /// Sorts the elements with IntroSort algorithm in an <see cref="Array" /> using the specified <see cref="IComparer{T}"/> generic interface.
        /// </summary>
        /// <typeparam name="T">The type of the elements of the array.</typeparam>
        /// <param name="array">The array to sort.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void IntroSort<T>(T[] array, IComparer<T> comparer)
        {
            int length = CheckArgumentsAndReturnLength(array);
            IntroSortCore(array, 0, length, comparer);
        }

        /// <summary>
        /// Sorts the elements with IntroSort algorithm in an <see cref="Array" /> using the specified <see cref="Comparison{T}"/>.
        /// </summary>
        /// <typeparam name="T">The type of the elements of the array.</typeparam>
        /// <param name="array">The array to sort.</param>
        ...
        /// <summary>
        /// Sorts the elements in a range of elements with IntroSort algorithm in an <see cref="Array" /> 
        /// using the <see cref="IComparable{T}"/> generic interface implementation of each element of the <see cref="Array" />.
        /// </summary>
        /// <typeparam name="T">The type of the elements of the array.</typeparam>
        /// <param name="array">The array to sort.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void IntroSort<T>(T[] array, int index, int length)
        {
        ...
        /// <summary>
        /// Sorts the elements in a range of elements with IntroSort algorithm in an <see cref="Array" /> using the specified <see cref="IComparer{T}"/> generic interface.
        /// </summary>
        /// <typeparam name="T">The type of the elements of the array.</typeparam>
        /// <param name="array">The array to sort.</param>
        /// <param name="index">The starting index of the range to sort.</param>
        ...
        /// or <see langword="null"/> to use the <see cref="IComparable{T}"/> generic interface implementation of each element.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void IntroSort<T>(T[] array, int index, int length, IComparer<T> comparer)
        {
            CheckArguments(array, index, length);
            IntroSortCore(array, 0, length, comparer);
        }
        ...
        /// <summary>
        /// Sorts the elements in a range of elements with IntroSort algorithm in an <see cref="IList{T}" />
        ...
        /// <summary>
        /// Sorts the elements in a range of elements with IntroSort algorithm in an <see cref="IList{T}" /> using the specified <see cref="IComparer{T}"/> generic interface.
        /// </summary>
        /// <typeparam name="T">The type of the elements of the list.</typeparam>
        /// <param name="list">The list to sort.</param>
        /// <param name="index">The starting index of the range to sort.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void IntroSortCore<T>(T[] array, int index, int length, IComparer<T> comparer)
        {
            if (length <= 0)
                return;
            IntroSortImpl.Sort(array, index, length, comparer);
        }
